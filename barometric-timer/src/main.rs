...
fn normal_mode<'a>(
    ...
    modeselect_pin: gpio::Pin<impl gpio::ValidFunction<gpio::FunctionSioInput>, gpio::FunctionSioInput, gpio::PullUp>,
    pac_i2c0: pac::I2C1,
    sda_pin: impl i2c::ValidPinSda<pac::I2C1> + gpio::AnyPin<Pull = gpio::PullUp>,
    scl_pin: impl i2c::ValidPinScl<pac::I2C1> + gpio::AnyPin<Pull = gpio::PullUp>,
    neopixel: impl gpio::AnyPin<Function = <pac::PIO0 as PIOExt>::PinFunction>,
    servo_pin: impl gpio::AnyPin<Id = impl pwm::ValidPwmOutputPin<pwm::Pwm5, pwm::A>>,
    timer: &'a mut Timer,
